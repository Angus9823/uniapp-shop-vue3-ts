...
// paddingTop = 55
console.log("Angus` safeAreaInsets sy", safeAreaInsets)
// console.log("safeAreaInsets.top", safeAreaInsets.top)
console.log("Angus` paddingTop sy", paddingTop)
...
<template>
  ...
  <view class="navbar" :style="{ paddingTop: paddingTop + 'px' }">
    ...
    <view class="logo">
      ...
      <image class="logo-image" src="@/static/images/allBy.png"></image>
      <!-- <text class="logo-text">新鲜 · 亲民 · 快捷</text> -->
      <text class="logo-text">前沿 · 活动 · 快捷</text>
    </view>
    <!-- 搜索条 -->
    <view class="search">
