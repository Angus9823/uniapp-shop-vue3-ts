...
const uploadFile = (file: string) => {
  ...
  uni.uploadFile({
    ...
    url: '/applet/whiteList/member/updateAvatar',
    name: 'file',
    filePath: file,
    success: (res) => {
...
const onFullLocationChange: UniHelper.RegionPickerOnChange = (ev) => {
  ...
  // 保存具体的省市区文字信息
  profile.value.provinceName = ev.detail.value[0]
  profile.value.cityName = ev.detail.value[1]
  profile.value.countyName = ev.detail.value[2]
  // 保存省市区的代码
...
const onSubmit = async () => {
  const { nickName, gender, birthday, profession, provinceName, cityName, countyName } = profile.value
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <picker @change="onFullLocationChange" mode="region" class="picker"
            ...
            <!-- <view class="placeholder">请选择城市</view> -->
          </picker>
        </view>
        <!-- #endif -->
        <!-- <view class="form-item">
